...
class StudentTopTabScreen extends StatefulWidget {
  final String email;
  final String name;
  final String mobile;
  ...
  @override
  State<StudentTopTabScreen> createState() => _StudentTopTabScreenState();
}

class _StudentTopTabScreenState extends State<StudentTopTabScreen> {
  @override
