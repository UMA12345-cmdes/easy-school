...
class StudentAdminChat extends StatefulWidget {
  final String email;
  StudentAdminChat({Key? key, required this.email}) : super(key: key);

  @override
  State<StudentAdminChat> createState() => _StudentAdminChatState();
}

class _StudentAdminChatState extends State<StudentAdminChat> {
  List element = [];
  @override
  void initState() {
    displayChat();
